    ...
    <div className="app">
      <div className="container"> 
        <div className="intro-text">
          ...
          <div className="text">
            <p>Navega por el mapa a continuación para explorar la fauna y flora de los municipios de Funes y Samaniego! Para cada especie encontrarás la ficha técnica con información sobre el estado de conservación, difusión y hábitat.</p>
          </div>
          <div className="video">
            <iframe width="100%" height="700" src="https://www.youtube.com/embed/Ll20MMXL0oM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>            
          </div>
        </div>
        ...
        <div className="text-container">  
          ...
          <div className="columns">
            <div className="column">
              ...
              Este catálogo es el resultado de una investigación primaria realizada por (Luis Alejandro Reyes Ballesteros y Zhara Cubillos Arias) y de un análisis exhaustivo de fuentes secundarias.</p>
            </div>
            <div className="column">
        ...
        <div className="text-container">  
          ...
          <div className="columns">
            ...
            <div className="column">
            <p>Por la tutela del medio ambiente, el proyecto ha realizado sistemas de tratamiento de aguas residuales y se llevan a cabo actividades de formación y sensibilización sobre biodiversidad en la comunidad.</p>
